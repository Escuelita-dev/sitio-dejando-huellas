<template>
    <span>
        <CabezalPaginaInterna :titulo="noticia.Titulo" :breadCrumb="breadCrumb()"/>
                    ...
                    <div class="row">                    
                        <div class="col-lg-9 col-md-12">
                            <div class="sidebar-spacer">
                                <div class="d-flex">
                                    <div class="post-date txt-blue">{{ moment(noticia.FechaPublicacion ? noticia.FechaPublicacion : noticia.published_at).format("DD MMM YYYY") }}</div>
                                    <!-- <div class="mx-2">/</div> -->
...
export default {
    ...
    methods: {
        ...
        breadCrumb: function() {
            return [
                {link: '/', nombre: 'Inicio'},
                {link: '/blog', nombre: 'Blog'},
                {link: `/blog/${this.noticia.Slug}`, nombre: this.noticia.Titulo}
            ]
        }
    }
}
